...
export default function HomepageFeatures(): ReactNode {
  ...
  const FeatureList: FeatureItem[] = isUrdu ? [
    {
      title: 'فزیکل اے آئی کی بنیادیں',
      ...
      description: (
        <>
          فزیکل اے آئی کے بنیادی تصورات اور مصنوعی ذہانت کو فزیکل روبوٹک سسٹمز کے ساتھ انضمام کو دریافت کریں۔
        </>
      ),
    },
    {
      ...
      description: (
        <>
          سینسر ٹیکنالوجیز، ادراک الگورتھم، اور روبوٹک سسٹمز کے لیے ملٹی موڈل انٹیگریشن کی جامع کوریج۔
        </>
      ),
    },
    {
      ...
      description: (
        <>
          الیکٹرک موٹرز، ہائیڈرولک سسٹمز، نیومیٹکس، اور سافٹ ایکچویٹرز سمیت روبوٹک ایکچویشن کے اصولوں میں مہارت حاصل کریں۔
        </>
      ),
    },
  ] : [
